...
////        }
//        std::cout << std::endl;
//        const auto moves = engine.get_moves(libchess::Position(position), depth,
...
//        std::cout << "MAX: " << get_san(libchess::Position(position), max.first) << ":" << max.second << " Searched: "
